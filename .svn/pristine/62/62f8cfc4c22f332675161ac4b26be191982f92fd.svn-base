	...
	<div class=" clearfix">
		<div id="category">
			...
			<iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0
				SCROLLING=AUTO
				SRC="${pageContext.request.contextPath}/manager/protype/to/handle.do"
	...
	callback: {
		beforeClick: function(treeId, treeNode) {
			...
			if (treeNode.isParent) {
				...
				demoIframe.attr("src",'${pageContext.request.contextPath}/manager/protype/to/handle.do?id='+treeNode.id);
				return true;
			}
		}
	}
