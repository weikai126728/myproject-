...
<body>
	...
	<div class="clearfix" id="add_picture">
		...
		<div class="page_right_style">
			...
			<form
				...
				<div class="clearfix cl">
					...
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${probability_fz.middleMoney }"
							...
							onchange="bijiao()">
							<input type="hidden" id="minmidd" value="${probability_fz.lowMoney }">
							<input type="hidden" id="maxmidd" value="${probability_fz.seniorMoney }">
				...
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>金额判定点下金额：</label>
					<div class="formControls col-10">
	...
	<script type="text/javascript">
		function bijiao(){
				if(parseInt($("#middleMoney").val())<parseInt($("#minmidd").val()) || parseInt($("#middleMoney").val())>parseInt($("#maxmidd").val())){
					layer.msg('值需大于${probability_fz.lowMoney }且小于${probability_fz.seniorMoney }', {
						icon : 5,
						time : 1000
					}, function(){
						location.reload();
