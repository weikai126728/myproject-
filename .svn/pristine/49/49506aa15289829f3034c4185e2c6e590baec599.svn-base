   ...
   <div class="type_title">发布动态</div>
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-10"><input maxlength="30" type="text" class="input-text" value="${market.productName }" placeholder="" id="productName" onchange="productData.productName=this.value"></div>
		</div>
	<div class="clearfix cl">
			<div class="Add_p_s">
            <label class="form-label col-2"><span style="color:red"></span>所属店铺：</label>
			<div class="formControls col-2"><input type="hidden" value="${market.marketid }"  id="marketid"><input maxlength="20" type="text" class="input-text" value="${market.name }" placeholder="" readonly="readonly" ></div>
            </div>
		</div>
		<div class="clearfix cl">
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-10"><input maxlength="300" type="text" class="input-text" value="${market.url}" placeholder="" id="productName" onchange="productData.productUrl=this.value"></div>
		</div>
		<div class="clearfix cl">
...
function product_save_submit(){
	...
	$.ajax({
         url: "${pageContext.request.contextPath}/manager/market/editVipcn.do",
         type: "POST",
         data: formData,
         /**
