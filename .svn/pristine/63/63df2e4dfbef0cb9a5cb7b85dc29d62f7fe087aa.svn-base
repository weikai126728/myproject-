...
//  								rightFont_imgClass: 'dw-icon-right', 	//右侧的图标信息
    								...
    								title:'2、元旦狂欢，礼惠全城！购物满200元，增30元红包',
    								hasHref:false,
    								href:'#',
...
//  								rightFont_imgClass: 'dw-icon-right', 	//右侧的图标信息 
    								...
    								title:'3、12月12日，全场商品惊爆超低价元旦狂欢，礼惠全城！购物满200元，增30元红包',
    								hasHref:false,
    								href:'#',
...
//  								rightFont_imgClass: 'dw-icon-right', 	//右侧的图标信息 
    								...
    								title:'4、元旦狂欢，礼惠全城！购物满200元，增30元红包',
    								hasHref:false,
    								href:'#',
...
//  								rightFont_imgClass: 'dw-icon-right', 	//右侧的图标信息 
    								...
    								title:'5、元旦狂欢，礼惠全城！购物满200元，增30元红包元旦狂欢，礼惠全城！购物满200元，增30元红包',
    								hasHref:false,
    								href:'#',
		...
		defaultvalue._init = function(){
			...
			for(var i = 0;i<length;i++){
				...
				if(opt.source[i].hasHref){
					_this.href = $('<span href="'+opt.source[i].href+'" target="'+opt.source[i].hrefType+'"></span>').appendTo(_this.cpt_li_menuList);
