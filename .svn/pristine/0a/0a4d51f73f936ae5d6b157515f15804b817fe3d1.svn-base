	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add" style="padding-left:40px;">
		...
		<div class="clearfix cl">
            ...
            <label class="form-label col-2"><span style="color:red"></span>积分：</label>
			 <div class="formControls col-10"><input maxlength="100" type="number" class="input-text" value="${market.productIntegral }" placeholder="" id="productIntegral" onchange="productData.productIntegral=this.value"></div>
            </div>
		</div> 
		<div class="clearfix cl">
	            ...
	            <div class="clearfix cl">
	             ...
	             <div class="formControls col-2">
					 <div class="input-group" style="width:140px">
						 <input type="number" class="form-control" value="${market.sproductParameter.cur_price }" placeholder="现价" id="current" name="current" step="0.01" onchange="productData.current=this.value">
...
/* 	productData.oldBanner = '';
    ...
    httpRequest.open("post",'${pageContext.request.contextPath}/manager/market/editproi.do',true);  
