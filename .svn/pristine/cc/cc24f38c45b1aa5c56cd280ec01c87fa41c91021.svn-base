...
<body>
	...
	<div class="clearfix" id="add_picture">
		<div class="page_right_style">
			<div class="type_title">修改新闻</div>
			<form
				action="${pageContext.request.contextPath}/company/news/edit.do"
				method="post" class="form form-horizontal"
				enctype="multipart/form-data" id="form-article-add">
				<input type="hidden" value="${news.id}" name="id">
				<input type="hidden" value="${news.smallImg}" name="smallImgs">
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>新闻标题：</label>
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${news.title }"
				...
				<div class="clearfix cl">
					...
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${news.abs }"
				...
				<div class="clearfix cl">
					...
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${news.degree }"
							name="degree" id="productName"
							onchange="productData.productName=this.value">
					</div>
				</div>
				<div class="clearfix cl">
							...
							<select id="pro-source" name="type"
								onchange="productData.productSource=this.value">
									<c:if test="${news.type==1 }">
										<option value="1" selected="selected">新闻要闻</option>
				...
				<div class="clearfix cl">
					...
					<div class="formControls col-2">
						<img alt="" id='large-img' src="${pageContext.request.contextPath}/image/showImage.do?image=${news.smallImg }"  
							style="width: 50px; height: 50px;"/> <input type="file" 
							style="display: none;" id="imgLarge" name="smallImg" /> <span id="btn-img-add1"  
						onclick="imgLarge.click()"	class="btn btn-success">修改图片</span>
					</div>
				</div>
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>新闻图片：</label>
					<div class="formControls col-2">
						<img alt="" id='small-img' src="${pageContext.request.contextPath}/image/showImage.do?image=${news.img }"  
							style="width: 50px; height: 50px;"/> <input type="file" 
							style="display: none;" id="imgSmall" name="file" /> <span id="btn-img-add0"  
						onclick="imgSmall.click()"	class="btn btn-success">修改图片</span>
					</div>
				</div>
				
				<input type="hidden"
							style="display: none;"   name="files"  value="${news.img }"/>
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>新闻内容：</label>
					<input type="text" name="details" id="content" hidden="hidden">
					<div class="formControls col-10 ">
						<div id="editor">${news.details }</div>
					</div>
				</div>
				<div class="clearfix cl">
