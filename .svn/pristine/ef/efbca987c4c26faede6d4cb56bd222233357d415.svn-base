					...
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								...
								<!-- <th width="80px">免单概率上限</th>
								<th width="70px">免单概率下限</th>
								<th width="70px">金额判定点上</th>
								<th width="70px">金额判定点中</th>
								<th width="250px">金额判定点下</th> -->
...
var oTable1;
var typeId = '${typeId}';
var merername='${merername}';
if(typeId==''){
	typeId=null;
}
jQuery(function($) {
		 
		var url = '${pageContext.request.contextPath}/redpack/queryLikeRedpackGailv.do?merername='+merername;
...
function member_edit(obj){
	...
	function selectUser(w, h) {
		var url = '${pageContext.request.contextPath}/redpack/queryLikeRedpackGailv.do?merername='
				+ $("#seleName").val();
		var title = '搜索结果';
