...
<body>
	...
	<div class="clearfix" id="add_picture">
		...
		<div class="page_right_style">
			<div class="type_title">修改红包概率</div>
			<form
				action="${pageContext.request.contextPath}/redpack/updateRedpackGailv.do"
				...
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>${probability_fz.lowMoney }元下概率：</label>
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${probability_fz.probability_1 }"
							name="probability_1" id="probability_1"
							onchange="probability_fzData.probability_1=this.value">
					</div>
				</div>
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>${probability_fz.lowMoney }元到${probability_fz.middleMoney }元概率：</label>
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${probability_fz.probability_2 }"
							name="probability_2" id="probability_2"
							onchange="probability_fzData.probability_2=this.value">
					</div>
				</div>
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>${probability_fz.middleMoney }元到${probability_fz.seniorMoney }元概率：</label>
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${probability_fz.probability_3 }"
							name="probability_3" id="probability_3"
							onchange="probability_fzData.probability_3=this.value">
					</div>
				</div>
				<div class="clearfix cl">
				...
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>红包上限个数：</label>
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${probability_fz.redlimit }"
							name="redlimit" id="redlimit"
							onchange="probability_fzData.redlimit=this.value">
					</div>
				</div>
				<%-- <div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>免单概率上限：</label>
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${probability_fz.pro_b }"
							name="pro_b" id="pro_b"
							onchange="probability_fzData.pro_b=this.value">
					</div>
				</div>
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>消费阶段一的金额：</label>
					<div class="formControls col-10">
				...
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>消费阶段二的金额：</label>
					<div class="formControls col-10">
				...
				<div class="clearfix cl">
					<label class="form-label col-2"><span style="color: red">*</span>消费阶段三的金额：</label>
					<div class="formControls col-10">
						<input maxlength="50" type="text" class="input-text" value="${probability_fz.seniorMoney }"
							name="seniorMoney" id="seniorMoney"
							onchange="probability_fzData.seniorMoney=this.value">
					</div>
				</div> --%>
