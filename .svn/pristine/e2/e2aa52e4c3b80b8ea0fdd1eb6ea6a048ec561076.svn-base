		...
		<div id="Member_Ratings">
			<div class="d_Confirm_Order_style">
				...
				<div class="border clearfix">
					<span class="l_f"> </span> <span class="r_f">共&nbsp;<b>${count }</b>&nbsp;条
					</span>
				</div>
				<!--  -->
							...
							<%-- <c:forEach items="${joinList }" var="list">
								<tr>
									...
									<td><a href="javascript:;"
										onclick="member_del(this,'${list.id}')" title="删除"
										class="btn btn-xs btn-warning"><i
											class="fa fa-trash  bigger-120">删除</i></a></td>
...
jQuery(function($) {
		var url = '${pageContext.request.contextPath}/manager/join/findByType.do';
 ...
 */
	...
	function member_del(obj, id) {
		layer.confirm('确认要删除吗？', function(index) {
			...
			$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/manager/join/deleteById.do",
			//提交的参数
			{
				joinId : id
			},
