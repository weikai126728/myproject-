...
<div id="add_administrator_style" class="add_menber" style="display:none">
    <form action="${pageContext.request.contextPath}/manager/radio/add.do" method="post" id="form-admin-add">
		<div class="form-group">
			<label class="form-label"><span class="c-red">*</span>标题：</label>
			<div class="formControls">
				<input type="text" class="input-text" value="" placeholder="" id="name" name="name" datatype="*2-16" nullmsg="标题不能为空">
			</div>
		...
		<div class="form-group">
			...
			<div class="formControls">
				<input type="text" class="input-text" value="" placeholder="" id="details" name="details" datatype="*2-50" nullmsg="详细内容不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
...
jQuery(function($) {
		...
		var url = '${pageContext.request.contextPath}/manager/radio/findByPage.do';
...
function member_stop(obj){
	...
	layer.confirm('确认要停用吗？',function(index){
		$.post('${pageContext.request.contextPath}/manager/radio/disable.do',{id:id},function(data){
			if(data.code==0){
				if(data.result==true){
...
function member_start(obj){
	...
	layer.confirm('确认要启用吗？',function(index){
		$.post('${pageContext.request.contextPath}/manager/radio/enable.do',{id:id},function(data){
			if(data.code==0){
				if(data.result==true){
...
function member_edit(obj){
	...
	var url = '${pageContext.request.contextPath}/manager/radio/toUpdate.do?id='+id;
...
function member_del(obj){
	...
	layer.confirm('确认要删除吗？',function(index){
		$.post('${pageContext.request.contextPath}/manager/radio/delete.do',{id:id},function(data){
			if(data.code==0){
				if(data.result==true){
...
$('#batchDel').on('click',function(){
	...
	$.post('${pageContext.request.contextPath}/manager/radio/batchDelete.do',{ids:ids},function(data){
		if(data.code==0){
			if(data.result==true){
