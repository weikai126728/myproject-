...
<body>
	...
	<div class="clearfix" id="add_picture">
		...
		<div class="page_right_style">
			<div class="type_title">红包发放</div>
			<form
				action="${pageContext.request.contextPath}/redpack/redpackFafang.do"
				...
				<div class="clearfix cl">
					...
					<div class="formControls col-10" style="width: 30%;">
						<input maxlength="50" type="text" class="input-text" value=""
							name="re_openid" id="re_openid" >
					</div>
				</div>
				<div class="clearfix cl">
					<label class="form-label col-2" style="width: 132px;"><span style="color: red">*</span>红包金额(单位分)：</label>
					<div class="formControls col-10" style="width: 30%;">
						<input maxlength="50" type="text"  class="input-text" value=""
	...
	$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/redpack/redpackFafang.do",
			//提交的参数
