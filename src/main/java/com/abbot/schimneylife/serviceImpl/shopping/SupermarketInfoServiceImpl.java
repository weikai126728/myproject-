...
public class SupermarketInfoServiceImpl implements SupermarketInfoService {
	...
	@Override
	public List<SmarketProductInfo> secondProiList() {
		List<SmarketProductInfo> list=Collections.emptyList();
		try {
			list=marketDao.secondProiList();
		} catch (Exception e) {
			logger.info("查询门便民列表",e);
		}
	...
	@Override
	public boolean secondStop(Integer proid) {
		try {
			marketDao.secondStop(proid);
			return true;
	} catch (Exception e) {
		logger.error("", e);
	}
	...
	@Override
	public boolean secondStart(Integer proid) {
		try {
			marketDao.secondStart(proid);
			return true;
	} catch (Exception e) {
		logger.error("", e);
	}
	...
	@Override
	public List<MarketProductInfo> storeProiList() {
		List<MarketProductInfo> list=Collections.emptyList();
		try {
			list=marketDao.storeProiList();
		} catch (Exception e) {
			logger.info("查询福利列表",e);
		}
	...
	@Override
	public boolean storeStop(Integer proid) {
		try {
			marketDao.storeStop(proid);
			return true;
	} catch (Exception e) {
		logger.error("", e);
	}
	...
	@Override
	public boolean storeStart(Integer proid) {
		try {
			marketDao.storeStart(proid);
			return true;
	} catch (Exception e) {
		logger.error("", e);
	}
	...
	@Override
	public boolean deleteStore(Integer proid) {
		try {
			marketDao.deleteStore(proid);
			return true;
	} catch (Exception e) {
		logger.error("", e);
	}
	...
	@Override
	public boolean deleteSecond(Integer proid) {
		try {
			marketDao.deleteSecond(proid);
			return true;
	} catch (Exception e) {
		logger.error("", e);
	}
	...
	@Override
	public MarketProductInfo storeProByid(Integer proid) {
		try {
			return marketDao.storeProByid(proid);
	} catch (Exception e) {
		logger.error("", e);
	}
		return null;
	...
	@Override
	public List<StoreClass> findStoreClass() {
		List<StoreClass> list=Collections.emptyList();
		try {
			list=marketDao.findStoreClass();
		} catch (Exception e) {
			logger.info("查询福利列表",e);
		}
	...
	@Override
	public void updateStore(MarketProductInfo info) {
		try {
			 marketDao.updateStore(info);
	} catch (Exception e) {
		logger.error("", e);
	}
	}
	...
	@Override
	public SmarketProductInfo SecondProByid(Integer marketId) {
		try {
			return marketDao.SecondProByid(marketId);
	} catch (Exception e) {
		logger.error("", e);
	}
		return null;
	...
	@Override
	public void updateSecond(SmarketProductInfo info) {
		try {
			 marketDao.updateSecond(info);
	} catch (Exception e) {
		logger.error("", e);
	}
	...
	@Override
	public void addStoreProduct(MarketProductInfo product) {
		try {
			 marketDao.addStoreProduct(product);
	} catch (Exception e) {
		logger.error("", e);
	}
