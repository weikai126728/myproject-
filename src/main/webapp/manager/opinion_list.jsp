					...
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								...
								<th width="80">姓名</th>
								<th width="100">手机</th>
								<th width="150">留言信息</th>
								<th width="180">问题场景</th>
...
jQuery(function($) {
		var url = '${pageContext.request.contextPath}/manager/opinion/findByType.do';
	...
	/* 用户-删除 */
	 function member_del(obj, id) {
		layer.confirm('确认要删除吗？', function(index) {
			...
			$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/manager/opinion/deleteById.do",
			//提交的参数
			{
				opinionId : id
			},
