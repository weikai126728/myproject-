   ...
   <div class="type_title" style="padding-left:40px;">编辑商品</div>
	<form action="" method="post" class="form form-horizontal" id="form-article-add" style="padding-left:40px;">
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-2">
				<img alt="" src="${pageContext.request.contextPath}/image/showImage.do?image=${market.gapImg}" id='small-img2' style="width:50px;height:50px;">
		...
		<div class="clearfix cl">
         <label class="form-label col-2"><div style="display: flex;justify-content: space-between;"><span style="    width: 30rem;">活动表单：</span>
         <c:if test="${market.productRadio==1 }">
         <input maxlength="50" type="checkbox" class="input-text" value="" checked="checked" placeholder="" id="productRadio">
         </c:if>
         <c:if test="${market.productRadio==0 }">
         <input maxlength="50" type="checkbox" class="input-text" value="" placeholder="" id="productRadio">
         </c:if>
         </div></label>
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-10"><input maxlength="50" type="text" class="input-text" value="${market.pbutton}" placeholder="" id="productButton" onchange="productData.productButton=this.value"></div>
		</div>
		<div class="clearfix cl">
...
function product_save_submit(){
    ...
    httpRequest.open("post",'${pageContext.request.contextPath}/manager/market/editShare.do',true);  
