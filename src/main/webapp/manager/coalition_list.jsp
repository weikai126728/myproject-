		...
		<div id="Member_Ratings">
			<div class="d_Confirm_Order_style">
				...
				<div class="border clearfix">
					<span class="l_f"> <a onclick="member_show('${market.name }','${pageContext.request.contextPath}/manager/benefit/goAdd.do','500','400')"
						id="member_add" class="btn btn-warning"><i class="icon-plus"></i>新增联盟</a>
							 ...
							 <c:forEach items="${marketList }" var="market">
								<tr>
									...
									<td><u style="cursor: pointer" class="text-primary"
										onclick="member_show('${market.name }','${pageContext.request.contextPath}/manager/market/marketShow.do?id=${market.id }','700','900')">${market.name }
									</u></td>
									...
									<c:if test="${market.status==1 }">
										...
										<td class="td-manage"><a
											...
											onclick="member_edit('编辑','${pageContext.request.contextPath}/manager/benefit/goEdit.do?marketId=${market.id}')"
...
jQuery(function($) {
				...
				.confirm(
						...
						function(index) {
							...
							$
									.post(
											//提交的路径	
											"${pageContext.request.contextPath}/manager/benefit/stop.do",
											//提交的参数
											{
												marketId : id
											},
				...
				.confirm(
						...
						function(index) {
							...
							$
									.post(
											//提交的路径	
											"${pageContext.request.contextPath}/manager/benefit/start.do",
											//提交的参数
											{
												marketId : id
											},
	...
	function member_del(obj, id) {
		layer.confirm('确认要删除吗？', function(index) {
			...
			$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/manager/benefit/deletecon.do",
			//提交的参数
			{
				marketId : id
			},
