...
function getTrading(obj){
	var alopenid = $(obj).attr("alopenid");
	alert(alopenid)
	parent.iframe.location.href = '${pageContext.request.contextPath}/manager/members/amount1.do?alopenid='+alopenid;
};
	/*字数限制*/
...
jQuery(function($) {
	var url = '${pageContext.request.contextPath}/manager/members/findByPage.do';
			...
			'ajax':{
				...
				'dataSrc':function(data){
					...
					for(var i=0;i<data.result.length;i++){
						...
						var handle = '<a alopenid="'+data.result[i].alopenid+'"  onClick="getTrading(this);" title="查看会员"  href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-line-chart bigger-120"></i></a>';
