...
var oTable1;
var typeId = '${typeId}';
var activitsName='${activitsName}';
if(typeId==''){
	typeId=null;
}
jQuery(function($) {
		var url = '${pageContext.request.contextPath}/redpack/getActivitiesLikeList.do?activitsName='+activitsName;
...
function member_edit(obj){
	...
	function selectActivities(w, h) {
		var url = '${pageContext.request.contextPath}/redpack/queryLikeRedpackGailvCount.do?activitsName='
				+ $("#activitsName").val();
		var title = '搜索结果';
