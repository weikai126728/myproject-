...
<div id="add_administrator_style" class="add_menber" style="text-align:center;">
    <form action="${pageContext.request.contextPath}/manager/tidings/update.do" method="post" id="form-admin-add" enctype="multipart/form-data">
		<input type="hidden" value="${tidings.id}" name="id">
		<div class="form-group">
			<label class="form-label"><span class="c-red">*</span>标题：</label>
			<div class="formControls">
				<input type="text" class="input-text" ignore="ignore" value="${tidings.name}" placeholder="" id="name" name="name" datatype="*2-50" nullmsg="标题不能为空">
			</div>
		...
		<div class="form-group">
			...
			<div class="formControls">
				<input type="text" class="input-text" ignore="ignore" value="${tidings.details}" placeholder="" id="details" name="details" datatype="*2-100" nullmsg="详细内容不能为空">
			</div>
			<div class="col-4"> <span class="Validform_checktip"></span></div>
		</div>
		<div class="form-group">
			...
			<div class="formControls">
				<img alt="" src="${pageContext.request.contextPath}/image/showImage.do?image=${tidings.image}" id='small-img' style="width:50px;height:50px;">
				<input type="file" class="input-text" ignore="ignore" value="" placeholder="" id="file" name="file" datatype="*2-100" nullmsg="图片不能为空" style="display:none;">
