...
<body>
	<div class="upload">
		<div class="upload_union">
			<div class="upload_sp">
				商圈名称：<input type="text" name="" value="" onchange="productData.productName=this.value">
			</div>
		</div>
		<div class="upload_in">
			<div class="upload_pt">
				姓名：<input type="text" name="" value="" onchange="productData.name=this.value">
			</div>
			<div class="upload_pt">
				电话：<input type="tel" name="" value="" onchange="productData.phone=this.value">
			</div>
			<div class="upload_pt">
				地址：<input type="text" name="" value="" onchange="productData.address=this.value">
			</div>
			<div class="upload_pt">
				openid：<input type="text" name="" value="" onchange="productData.openid=this.value">
			</div>
			<div class="upload_pt">
		...
		<div class="upload_up">
			<div class="up_load" style="width:70%;margin:0 auto;border:0;">
				<img alt="" src="" id='small-img' style="width:80px;height:80px;">
		...
		<div class="upload_up">
			<div class="up_load" style="width:70%;margin:0 auto;border:0;">
				<img alt="" src="" id='small-img1' style="width:80px;height:80px;">
...
function product_save_submit(){
	...
	formData.append('hopenid',productData.openid);
...
httpRequest.open("post",'${pageContext.request.contextPath}/manager/benefit/upload.do',true);  
