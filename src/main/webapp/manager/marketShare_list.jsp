					...
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								...
								<th width="120">活动店铺</th>
								<th width="180">活动图片轮播</th>
								<th width="180">活动图片详情图</th>
								<th width="250">活动状态</th>
								<th width="250">操作</th>
							</tr>
						</thead>
						<tbody>
									...
									<c:forEach items="${str}" var="b">
									 ...
									 <img src="${pageContext.request.contextPath}/image/showImage.do?image=${b}" alt="" style="width: 4rem;height:3rem"/>
										...
										<td class="td-manage"><a
											...
											onclick="member_edit('编辑','${pageContext.request.contextPath}/manager/market/goEditShare.do?marketId=${pro.id}')"
...
jQuery(function($) {
				...
				.confirm(
						...
						function(index) {
							...
							$
									.post(
											//提交的路径	
											"${pageContext.request.contextPath}/manager/market/stopShare.do",
											//提交的参数
											{
												proid : id
											},
				...
				.confirm(
						...
						function(index) {
							...
							$
									.post(
											//提交的路径	
											"${pageContext.request.contextPath}/manager/market/startShare.do",
											//提交的参数
											{
												proid : id
											},
	...
	function member_del(obj, id) {
		layer.confirm('确认要删除吗？', function(index) {
			...
			$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/manager/market/deleteMarketShare.do",
			//提交的参数
			{
				marketId : id
			},
