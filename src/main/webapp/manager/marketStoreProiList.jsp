									...
									<c:forEach items="${str}" var="b">
									 ...
									 <img src="${pageContext.request.contextPath}/image/showImage.do?image=${b}" alt="" style="width: 4rem;height:3rem"/>
										...
										<td class="td-manage"><a
											...
											onclick="member_edit('编辑','${pageContext.request.contextPath}/manager/market/goEditStore.do?marketId=${pro.id}')"
...
jQuery(function($) {
				...
				.confirm(
						...
						function(index) {
							...
							$
									.post(
											//提交的路径	
											"${pageContext.request.contextPath}/manager/market/storeStop.do",
											//提交的参数
											{
												proid : id
											},
				...
				.confirm(
						...
						function(index) {
							...
							$
									.post(
											//提交的路径	
											"${pageContext.request.contextPath}/manager/market/storeStart.do",
											//提交的参数
											{
												proid : id
											},
	...
	function member_del(obj, id) {
		layer.confirm('确认要删除吗？', function(index) {
			...
			$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/manager/market/deleteStore.do",
			//提交的参数
			{
				id : id
			},
