								...
								<tr>
									...
									<c:if test="${user.status==1 }">
										...
										<td class="td-manage"><a
											...
											href="javascript:;" class="btn btn-xs btn-info"><i
												...
												<a title="详情" href="javascript:;  "onclick="member_detail(this,'${user.phone}',500,400)" class="btn btn-xs btn-warning"><i	class="bigger-120">详情</i></a></td>
									</c:if>
									<c:if test="${user.status==0 }">
										...
										<td class="td-manage"><a style="text-decoration: none"
											...
											href="javascript:;" class="btn btn-xs btn-info"><i
												class="icon-edit bigger-120"></i></a>
												<a title="详情" href="javascript:void(0);  "onclick="member_detail(this,'${user.phone}',500,400)" class="btn btn-xs btn-warning"><i	class="bigger-120">详情</i></a></td>
									</c:if>
								</tr>
