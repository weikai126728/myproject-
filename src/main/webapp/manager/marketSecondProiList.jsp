							 ...
							 <c:forEach items="${ProList }" var="pro">
								<tr>
									...
									<td><u style="cursor: pointer" class="text-primary"
										onclick="member_show('${pro.openid }','${pageContext.request.contextPath}/manager/market/marketShow.do?id=${pro.openid }','500','400')">${pro.openid }
									</u></td>
									<td>${pro.smname }</td>
									...
									<c:forEach items="${str}" var="b">
									 ...
									 <img src="${pageContext.request.contextPath}/image/showImage.do?image=${b}" alt="" style="width: 4rem;height:3rem"/>
										...
										<td class="td-manage"><a
											...
											onclick="member_edit('编辑','${pageContext.request.contextPath}/manager/market/goEditSecond.do?marketId=${pro.id}')"
...
jQuery(function($) {
				...
				.confirm(
						...
						function(index) {
							...
							$
									.post(
											//提交的路径	
											"${pageContext.request.contextPath}/manager/market/secondStop.do",
											//提交的参数
											{
												proid : id
											},
				...
				.confirm(
						...
						function(index) {
							...
							$
									.post(
											//提交的路径	
											"${pageContext.request.contextPath}/manager/market/secondStart.do",
											//提交的参数
											{
												proid : id
											},
	...
	function member_del(obj, id) {
		layer.confirm('确认要删除吗？', function(index) {
			...
			$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/manager/market/deleteSecond.do",
			//提交的参数
			{
				id : id
			},
			...
			function(date) {
				//如果返回的结果不为空
				if (date.result == "true"||date.result == true) {
