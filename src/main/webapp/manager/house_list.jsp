...
<body>
	<div class="page-content clearfix">
       ...
       <span class="l_f">
        <a href="${pageContext.request.contextPath}/manager/house/toAdd.do" title="添加房产" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
...
jQuery(function($) {
	...
	function member_del(obj, id) {
		layer.confirm('确认要删除吗？', function(index) {
			...
			$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/manager/market/deleteMarket",
			//提交的参数
			{
				marketId : id
			},
