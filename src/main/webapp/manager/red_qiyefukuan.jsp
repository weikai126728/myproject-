...
<body>
	...
	<div class="clearfix" id="add_picture">
		...
		<div class="page_right_style">
			<div class="type_title">企业转账</div>
			<form
				action="${pageContext.request.contextPath}/redpack/redpackQiyezhuanzhang.do"
				method="post" class="form form-horizontal"
				enctype="multipart/form-data" id="form-article-add">
				<div class="clearfix cl">
					<label class="form-label col-2" style="width: 132px;"><span style="color: red">*</span>接收方OPENID：</label>
					<div class="formControls col-10" style="width: 30%;">
						<input maxlength="50" type="text" class="input-text" value=""
							name="alopenid" id="alopenid"
							>
					</div>
				</div>
				<div class="clearfix cl">
					<label class="form-label col-2" style="width: 132px;"><span style="color: red">*</span>转账金额(单位分)：</label>
					<div class="formControls col-10" style="width: 30%;">
						<input maxlength="50" type="text"  class="input-text" value=""
							name="merchantpayment" id="merchantpayment"
							>
					</div>
				</div>
				<div class="clearfix cl">
					<div class="Button_operation">
						<input class="btn btn-primary radius" type="button" value="转账" onclick="zhuanzhang()">
					</div>
				</div>
			</form>
		</div>
	...
	$.post(
			//提交的路径	
			"${pageContext.request.contextPath}/redpack/redpackQiyezhuanzhang.do",
			//提交的参数
