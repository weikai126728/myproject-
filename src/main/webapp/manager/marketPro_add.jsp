   ...
   <div class="type_title">添加商品</div>
	...
	<div class="clearfix cl">
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-10"><input maxlength="50" type="text" class="input-text" value="" placeholder="" id="productUrlName" onchange="productData.productUrlName=this.value"></div>
		</div>
		<div class="clearfix cl">
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-2">
				<img alt="" src="" id='small-img3' style="width:50px;height:50px;">
            ...
            <label class="form-label col-2"><span style="color:red"></span>推广距离：</label>
			 <div class="formControls col-10"><input maxlength="100" type="number"  class="input-text" value="10" placeholder="" id="dis" ></div>
            </div>
		</div>
		<div class="clearfix cl">
			<div class="Add_p_s">
            <label class="form-label col-2"><span style="color:red"></span>下单按钮：</label>
			 <div class="formControls col-10"><input maxlength="100" type="text" class="input-text" value="" placeholder="" id="pbutton" onchange="productData.pbutton=this.value"></div>
            </div>
		</div>
