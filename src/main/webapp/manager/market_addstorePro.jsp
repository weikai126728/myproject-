   ...
   <div class="page_right_styl" style="width: 100%;">
	...
	<select name="" id="bmclass" onchange="getmclass()" >
		...
		<div class="clearfix cl">
		 ...
		 <textarea name="" id="" cols="" rows=""  onchange="productData.productName=this.value"></textarea>
		 <!-- <input maxlength="250" type="text" class="input-text" value="" placeholder="" id="productName" onchange="productData.productName=this.value"> -->
		 </div>
		</div>
...
function product_save_submit(){
	...
	$.ajax({
        url: "${pageContext.request.contextPath}/manager/market/uploadStore.do",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
