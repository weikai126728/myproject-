   ...
   <div class="type_title" style="padding-left:40px;">编辑商品</div>
	<form action="" method="post" class="form form-horizontal" id="form-article-add" style="padding-left:40px;">
		...
		<div class=" clearfix cl">
	     ...
	     <div class="formControls col-10"><input maxlength="200" type="text" class="input-text" value="${market.productDetails}" placeholder="" id="productDetails" onchange="productData.productDetails=this.value"></div>
		</div>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-2"><input type="date" step="01" name="user_date" id="user_date" value="${market.countdown.substring(0,10)}"   onchange="productData.user_date=this.value"></div>
            </div>
		</div>
		<div class="clearfix cl">
			<div class="Add_p_s">
            <label class="form-label col-2"><span style="color:red"></span>佣金设定：</label>
			 <div class="formControls col-10"><input maxlength="100" type="number" class="input-text" value="${market.comm}" placeholder="" id="comm" onchange="productData.comm=this.value"></div>
            </div>
		</div>
			<div class="clearfix cl">
			<div class="Add_p_s">
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-10"><input maxlength="200" type="text" class="input-text" value="${market.productName}" placeholder="" id="productName" onchange="productData.productName=this.value"></div>
		</div>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-2">
				<img alt="" src="${pageContext.request.contextPath}/image/showImage.do?image=${market.videoImg}" id='small-img1' style="width:50px;height:50px;">
		...
		<div class="clearfix cl">
         <label class="form-label col-2"><span style="color:red"></span>外链名称：</label>
		 <div class="formControls col-10"><input maxlength="50" type="text" class="input-text" value="${market.urlname}" placeholder="" id="productUrl" onchange="productData.productUrlName=this.value"></div>
		</div>
		<div class="clearfix cl">
         <label class="form-label col-2"><span style="color:red"></span>活动外链：</label>
		 <div class="formControls col-10"><input maxlength="200" type="text" class="input-text" value="${market.url}" placeholder="" id="productUrl" onchange="productData.productUrl=this.value"></div>
		</div>
		<div class="clearfix cl">
			<label class="form-label col-2"><span style="color:red">*</span>间隔图：</label>
			<div class="formControls col-2">
				<img alt="" src="${pageContext.request.contextPath}/image/showImage.do?image=${market.gapImg}" id='small-img3' style="width:50px;height:50px;">
				<input type="file" style="display: none;" id="imgSmall3" name="imgSmall3" />
				<span id="btn-img-add0" onclick="imgSmall3.click()" class="btn btn-success">添加图片</span>
			</div>
		</div>
		
		
			<div class="clearfix cl">
			<label class="form-label col-2"><span style="color:red">*</span>推广图：</label>
			<div class="formControls col-2">
				<img alt="" src="${pageContext.request.contextPath}/image/showImage.do?image=${market.posters}" id='small-img2' style="width:50px;height:50px;">
			...
			<div class="clearfix cl">
			<div class="Add_p_s">
            <label class="form-label col-2"><span style="color:red"></span>推广距离：</label>
			 <div class="formControls col-10"><input maxlength="100" type="number"  class="input-text" value="${market.dis}" placeholder="" id="dis"  onchange="productData.dis=this.value"></div>
            </div>
		</div>
		<div class="clearfix cl">
			<div class="Add_p_s">
            <label class="form-label col-2"><span style="color:red"></span>下单按钮：</label>
			 <div class="formControls col-10"><input maxlength="100" type="text" class="input-text" value="${market.pbutton}" placeholder="" id="pbutton" onchange="productData.pbutton=this.value"></div>
            </div>
		</div>
			<div class="clearfix cl">
...
function test(obj){
	...
	if(suffix!=".mp4"&&suffix!=".avi"&&suffix!=".3gp"&&suffix!=".rmvb"&&suffix!=".rm"&&suffix!=".fiv"){  //根据后缀，判断是否符合图片格式
...
function product_save_submit(){
	...
	if(productData.productUrlName){
		formData.append('productUrlName',productData.productUrlName);
	}
	if(productData.pbutton){
		formData.append('pbutton',productData.pbutton);
	}
	if(files!=null){
	...
	if(productData.dis){
		formData.append('dis',productData.dis);
		}	
	...
	if(productData.productIntegral){
