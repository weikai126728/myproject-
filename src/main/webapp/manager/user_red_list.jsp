		...
		<form
			...
			<ul class=" page-content">
				...
				<li><label class="label_name">移动电话：</label><span
					...
					<div class="prompt r_f"></div></li>
				<li><label class="label_number">网红编号：</label><span
					class="add_number"><input name="number" type="text"
						maxlength="11" class="text_add" /></span>
					<div class="prompt r_f"></div></li>
...
// 							"aaSorting" : [ [ 1, "desc" ] ],//默认第几个排序
	...
	function orderList(obj){
		...
		location.href = '${pageContext.request.contextPath}/manager/order/redOrderList.do?userId='+userId+'&linered=0';
	}
	laydate({
		elem : '#start',
		event : 'focus'
